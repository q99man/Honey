...
Run end-to-end emulator QA for image upload flows against a live backend, then continue authenticated Saved Places and Community list/card M3 detail polish.
