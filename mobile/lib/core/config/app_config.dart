...
class AppConfig {
  static const _configuredApiBaseUrl =
      String.fromEnvironment('HONEY_API_BASE_URL');
  static const _configuredDevApiBaseUrl =
      String.fromEnvironment('HONEY_DEV_API_BASE_URL');
  static const _configuredProdApiBaseUrl =
